                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="comment-widgets" style="height:430px;">
                                ...
                                <!-- Comment Row -->
                               <?php   $queryL   ="SELECT *
    FROM contactus    WHERE company_id ={$_SESSION['Company_ID']} ORDER BY `contactus`.`ID` DESC ";
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
$queryA="SELECT  SUM(Total_amount)FROM customers_request WHERE company_id ={$_SESSION['Company_ID']}";

$resultA  = mysqli_query($conn,$queryA);
$rowA=mysqli_fetch_assoc($resultA);
$queryB="SELECT COUNT(*) FROM customers_request WHERE company_id ={$_SESSION['Company_ID']}";
                                ...
                                <div class="m-t-30">
                                    <div class="row text-center">
                                        ...
                                        <div class="col-6 border-right">
                                            <h4 class="m-b-0"><?php  echo "{$rowA['SUM(Total_amount)']} $"; ?></h4>
                                            <span class="font-14 text-muted">Total Earning</span>
                                        </div>
