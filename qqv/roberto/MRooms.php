...
echo "<script type='text/javascript'>alert('SORRY THIS ROOM NOT Available');

   window.location.assign('MRooms.php');
</script> 
...
<script type="text/javascript"> </script>
    ...
    <div class=" breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(img/bg-img/166.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">OUR MEETING ROOMS</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page"> Meeting Rooms</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<!--  Company_id=$ComID AND -->
                    <?php   $queryAll="SELECT * FROM rooms_and_tables WHERE  Company_id=$ComID AND is_Room=1  ";
...
$last_word = substr($rowALL['name'], $last_word_start);
 echo $last_word;
    ...
    $('#ONdate').attr('min', minDate);
            ...
            { 
                type: "GET",
                url: "RandTAjax.php?ComID="+ <?php echo "$ComID "?>+"&RorT="+1+"&BokDate="+BokDate+"&TRsize="+TRsize+"&duration="+duration+"&startTime="+StrtTime,
...
echo $now->format('Y-m-d');    // MySQL datetime format
 ?>
                         ...
                         <div class="col-6  mt-4 ">
                             <label class="col-7 text-center" >FOR :</label>
                             <div class="row">
                    ...
                    <div  class="form-group col-12 text-center">
                        <div  style="" id="RoomS"   class=" col-8 btn roberto-btn w-100">Check Available</div>
                    </div>
                </form>
            </div>
        </div>
